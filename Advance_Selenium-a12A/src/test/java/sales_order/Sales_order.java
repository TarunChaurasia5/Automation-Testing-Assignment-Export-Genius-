...
public class Sales_order {
    ...
    public static void main(String[] args) throws IOException {
        ...
        driver.findElement(By.name("subject")).sendKeys("Order Echo");
        driver.findElement(By.id("customerno")).sendKeys("CUST005");
        ...
        driver.findElement(By.name("sostatus")).sendKeys("Created");
