...
public class Organization {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        driver.findElement(By.name("accountname")).sendKeys("Org Test 5");
        driver.findElement(By.className("detailedViewTextBox")).sendKeys("www.org5.com");
        ...
        driver.findElement(By.id("email1")).sendKeys("contact5@example.com");
