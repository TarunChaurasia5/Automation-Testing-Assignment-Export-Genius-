...
public class test_script_contact {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		String EM = sh.getRow(1).getCell(2).getStringCellValue();
//		double MO = sh.getRow(1).getCell(3).getNumericCellValue();
//		String CO = sh.getRow(1).getCell(4).getStringCellValue();
//		String CI = sh.getRow(1).getCell(5).getStringCellValue();
//		String AD = sh.getRow(1).getCell(6).getStringCellValue();
//		
